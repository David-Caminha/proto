            ...
            <div class="col-xs-10 col-sm-4 col-md-4 col-md-offset-2">
                <form class="register-form" action="{$BASE_URL}actions/users/register.php" method="post">
                    ...
                    <div class="user box">
                        ...
                        <h7>Codigo Postal</h7> 
                        <input class="form-control col-xs-3 col-sm-3 col-md-3" type="text" name="cp1"  value="{$FORM_VALUES.cp1}"> 
                        <input class="form-control col-xs-3 col-sm-3 col-md-3" type="text" name="cp2"  value="{$FORM_VALUES.cp2}"> 
