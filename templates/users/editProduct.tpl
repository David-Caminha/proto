...
{if $FORNECEDOR}
	<div id="edit_product_wrapper">
		<form action="{$BASE_URL}pages/users/insertProduct.php" method="post" >
			...
			Descrição:<textarea rows="6" cols="50" name="description" placeholder="Escreva aqui uma descrição do produto..." value="$p.descricao"></textarea><br/>
			<!-- 	Imagem:
			<input type="file" name="fileToUpload" id="fileToUpload"> -->	
			Ficha Técnica:<textarea rows="6" cols="50" value="$p.fichatecnica" name="technic_details" placeholder="Escreva aqui os tópicos da ficha técnica..."></textarea><br/>
